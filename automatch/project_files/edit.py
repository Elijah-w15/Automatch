...
RESUME_EMBED = CONFIG_DIR / "resume_embed.txt"   # matches automatch/paths.py
...
# ===== strip preview: a faithful MIRROR of automatch/score.py (which can't be
...
TAG_MORE = (
    ...
    "  a working example ships at docs/resume_template.example.docx\n")
...
TAG_FORMAT_MORE = (
    ...
    "  see docs/resume_template.example.docx for a full one.\n")
